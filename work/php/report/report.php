...
<h2>S10</h2>
        ...
        <p class="report-answer">
            So me and my team implemented our project, a weekly to-do application, utilizing ASP.NET as our development platform, writing it in C# and utilzing MySQL as our DBMS. We aimed for grade 5. We developed pages that are partly server-side generated with the help of Razor, but then we also utilized a RestAPI to dynamically change the content of the pages. I feel that that was the way to go for this type of application we created. There is still a lot of room for improvement however, but this comes with experience.<br/>
            During the course of the project we sure faced some problems but nothing that was to hard to overcome. The main issue we had was understanding the capabilities of ASP.NET since it is a totally new development platform for us. I feel that we got the hang of it at the end of the project but there is still much left to learn.For example, we solved some issues that we realised could have been solved in a different way by utlizing the packages/libraries that we didn't know of at that time. Overall the project difficulty was medium, a lot of new stuff to learn but due to C# being very similar to Java we could quickly code the project.<br/>
